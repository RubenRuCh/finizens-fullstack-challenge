...
export class SearchNonCompletedInvestmentOrdersByPortfolioIdQueryHandler implements QueryHandler<SearchNonCompletedInvestmentOrdersByPortfolioIdQuery, SearchInvestmentOrdersResponse> {
